...
"""
# NM-PROBE token under test: cuda::atomic_ref   cuda::memory_order_release   cuda::memory_order_acquire
import torch
...
/* NM-PROBE: cuda::atomic_ref   cuda::memory_order_release   cuda::memory_order_acquire */
#include <vector>
#include <algorithm>
